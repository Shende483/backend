...
// import MyDefinedRules from '../overview/cards-data/MyDefinedRules';
// import AlertingDetails from '../overview/cards-data/AlertingDetails';
...
import { MyAccountsDetails } from '../overview/cards-data/MyAccountsDetails';
